# FinalCap iOS — required Info / build keys for ASC
...
| `INFOPLIST_KEY_CFBundleDisplayName` | `FinalCap` | Home screen |
| `INFOPLIST_KEY_ITSAppUsesNonExemptEncryption` | `NO` | Export compliance |
| `INFOPLIST_KEY_NSPhotoLibraryUsageDescription` | Import videos to edit in FinalCap. | Photos import |
